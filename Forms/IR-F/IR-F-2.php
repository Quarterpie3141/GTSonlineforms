...
<?php
    ...
    if($_SESSION["loggedin"] == false){
        $_SESSION['Desuri'] = "location: ../../Forms/IR-f/IR-F-2.php";
    ...
    Userconsent,
    positionofworker FROM ir_f_db WHERE formid = ?";
...
<body>
    ...
    <form style="margin: 190px;" action="submit/IR-F-2.php" method="POST">
        ...
        <div class="row mb-3">
            ...
            <div class="col-8">
                <div class=" textinput" style="top: 0%; position: relative;">
                    <input type="text" name="nameofmanager" class="form-control form-control-lg" placeholder="<?php echo $_SESSION['username'] ?>">
                </div> 
            </div>
        </div>
        <br>
        <div class="row mb-3">
            ...
            <div class="col-3">
                <div class="textinput" style="top: 0%; position: relative;">
                    <input type="text" name="f2phone" class="form-control form-control-lg" placeholder="">
                </div> 
            </div>
            <div class="col-3">
